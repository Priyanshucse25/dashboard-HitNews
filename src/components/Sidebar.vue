...
const updateLogo = async (event) => {
  ...
  try {
    await axios.put("https://backend-owra.onrender.com/api/logo", formData, {
      headers: {
...
const fetchLogo = async () => {
  try {
    const response = await axios.get(
      "https://backend-owra.onrender.com/api/logo",
      {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
...
const deleteCategory = async (strategy) => {
  try {
    ...
    await axios.delete(
      `https://backend-owra.onrender.com/api/categories/category/${categoryId}`,
      {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
...
const saveBanner = async () => {
  ...
  try {
    await axios.post("https://backend-owra.onrender.com/api/banner", formData, {
      headers: {
        "Content-Type": "multipart/form-data",
        Authorization: `Bearer ${localStorage.getItem("token")}`,
      },
